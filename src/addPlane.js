    ...
    return(
        <div className="App">
            ...
            <label>Бортовой номер (номер гос.регистрации/ID самолёта)
                ...
                onChange={(e)=>{setPlaneId(e.target.value)}}></input>
            </label>
            <label>Тип самолёта
            ...
            <label class="classes">Классы
                <label><input type="checkbox" id='econom' placeholder='Эконом' value={classes} onChange={(e)=>{setClasses(+e.target.value)}}></input>Эконом</label>
                <label><input type="checkbox" id='business' placeholder='Бизнес' value={classes} onChange={(e)=>{setClasses(+e.target.value)}}></input>Бизнес</label>
                <label><input type="checkbox" id='vip' placeholder='VIP' value={classes} onChange={(e)=>setClasses(+e.target.value)}></input>VIP</label>
            </label>
            <label>Авиалинии
                <input type="text" id='aeroplane_name' value={avialines}
                onChange={(e)=>{setAvialines(e.target.value)}}></input>
            </label>
            <label>Кол-во входов
                <input type="number" id='plane_name' value={entries_number}
                onChange={(e)=>{setEntriesNumber(e.target.value)}}></input>
            </label>
            ...
            <label>Ёмкость бензобака (в литрах)
                <input type="text" id='plane_name' value={fueltank_capacity}
