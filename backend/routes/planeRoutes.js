...
router.post("/add",upload.single('image'),plane.add)
...
router.get("/get_due_query_AND",plane.get_due_query_typeANDclasses)
router.get("/get_due_query_OR",plane.get_due_query_typeORnameORclasses)
